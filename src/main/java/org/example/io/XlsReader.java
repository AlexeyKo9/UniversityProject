...
public class XlsReader {
    ...
    public static List<University> readUniversities(String filePath) {
        ...
        try {
            ...
            logger.log(Level.INFO, "Excel reading started. List University");
        ...
        logger.log(Level.INFO, "Excel reading finished successfully. List University");
        return universities;
    }
    ...
    public static List<Student> readStudents(String filePath) {
        ...
        try {
            ...
            logger.log(Level.INFO, "Excel reading started. List Student");
        ...
        logger.log(Level.INFO, "Excel reading finished successfully. List Student");
        return students;
    }
}
